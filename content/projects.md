...
<div class="project-card">
  ...
  <div class="sub-project">
    <h3><a href="https://github.com/psibi/tldr-hs" target="_blank" rel="noopener noreferrer">tldr-hs</a></h3>
    <p>A native Haskell client for <a href="https://tldr.sh" target="_blank" rel="noopener noreferrer">tldr pages</a> (simplified, community-driven man pages). Features offline caching, platform-specific page filtering, and multi-language support. Available on <strong>Hackage</strong> and <strong>Stackage</strong>.</p>
  </div>
  <div class="sub-project">
